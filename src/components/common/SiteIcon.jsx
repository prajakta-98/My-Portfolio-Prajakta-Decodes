const iconPaths = {
  ...
  palm: (
    <>
      <path d="M8.5 11.5V6.8a1.3 1.3 0 0 1 2.6 0v4.1" />
      <path d="M11.1 10.3V5.6a1.3 1.3 0 0 1 2.6 0v5" />
      <path d="M13.7 10.7V6.4a1.3 1.3 0 0 1 2.6 0v5.8" />
      <path d="M16.3 12.1V8.4a1.3 1.3 0 0 1 2.6 0v5.1c0 4.4-2.4 7.1-6.3 7.1h-.8c-2.2 0-3.7-.9-4.9-2.5l-2.2-3a1.35 1.35 0 0 1 2.1-1.7l1.7 1.7" />
      <path d="M8.5 15.1v-3.6" />
    </>
  ),
  clock: (
    <>
