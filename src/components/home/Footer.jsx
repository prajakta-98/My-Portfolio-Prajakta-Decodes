  ...
  return (
    <footer className="modern-footer">
      <div className="footer-shell">
        <div
          className="footer-simple-nav"
          role="navigation"
          aria-label="Footer navigation"
        >
          <a href="#home-hero" className="footer-mini-brand">
            {"{Praj-Decodes}"}
          </a>
        ...
        <div className="footer-connect-block">
          <div className="social-pills-container" id="pills-trigger">
            ...
            <a
              href="https://www.instagram.com/heyits_prajakta/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="social-pill behance"
            >
              <span className="pill-icon">Behance</span>
            </a>
            <a
              href="mailto:prajaktab777@gmail.com"
              className="social-pill email"
            >
        ...
        <div
          ...
          aria-label="Prajakta Decodes brand panel"
        >
        ...
        <div className="footer-bottom">
          <p>&copy; 2026 Prajakta-Decodes. Designed with ❤️ and precision.</p>
